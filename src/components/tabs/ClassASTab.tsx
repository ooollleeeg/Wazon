...
const classASConfig: TabConfig = {
  ...
  CardComponent: ClassASCard,
  FormComponent: ClassASForm,
  ListComponent: ClassASList,
};

export default function ClassASTab() {
  return <GenericTab config={classASConfig} />;
}
